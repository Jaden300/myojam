...
export default function Landing() {
  ...
  return (
    <div style={{ maxWidth: 720, margin: "0 auto", padding: "80px 24px" }}>
      ...
      <p style={{
        fontSize: 18, color: "#94a3b8", lineHeight: 1.8, marginBottom: 16
      }}>
      ...
      <p style={{
        fontSize: 18, color: "#94a3b8", lineHeight: 1.8, marginBottom: 48
      }}>
      ...
      <div style={{ display: "flex", gap: 14, flexWrap: "wrap" }}>
        ...
        >
          ...
          href="https://github.com/yourusername/myosignal"
          target="_blank"
          rel="noreferrer"
          style={{
